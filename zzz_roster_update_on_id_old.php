...
function check_r_firstname($candidate, &$fail_string)
{
	check_anynonemptystring($candidate, &$fail_string);
}

function check_r_lastname($candidate, &$fail_string)
{
	check_anynonemptystring($candidate, &$fail_string);
}
...
function check_r_firstname($candidate, &$fail_string)
{
	...
	function check_r_email($candidate, &$fail_string)
{
	check_anynonemptystring($candidate, &$fail_string);
}
	function check_r_cellphone($candidate, &$fail_string)
{
	check_anynonemptystring($candidate, &$fail_string);
}
	function check_r_homephone($candidate, &$fail_string)
{
	check_anynonemptystring($candidate, &$fail_string);
}
	function check_r_street($candidate, &$fail_string)
{
	check_anynonemptystring($candidate, &$fail_string);
}
	function check_r_town($candidate, &$fail_string)
{
	check_anynonemptystring($candidate, &$fail_string);
}
	function check_r_state($candidate, &$fail_string)
{
	check_anynonemptystring($candidate, &$fail_string);
}
	function check_r_zip($candidate, &$fail_string)
{
	check_anynonemptystring($candidate, &$fail_string);
}
	function check_p1_firstname($candidate, &$fail_string)
{
	check_anynonemptystring($candidate, &$fail_string);
}
	function check_p1_lastname($candidate, &$fail_string)
{
	check_anynonemptystring($candidate, &$fail_string);
}
	function check_p1_email($candidate, &$fail_string)
{
	check_anynonemptystring($candidate, &$fail_string);
}
	function check_p1_cellphone($candidate, &$fail_string)
{
	check_anynonemptystring($candidate, &$fail_string);
}
	function check_p2_firstname($candidate, &$fail_string)
{
	check_anynonemptystring($candidate, &$fail_string);
}
	function check_p2_lastname($candidate, &$fail_string)
{
	check_anynonemptystring($candidate, &$fail_string);
}
	function check_p2_email($candidate, &$fail_string)
{
	check_anynonemptystring($candidate, &$fail_string);
}
	function check_p2_cellphone($candidate, &$fail_string)
{
	check_anynonemptystring($candidate, &$fail_string);
}
