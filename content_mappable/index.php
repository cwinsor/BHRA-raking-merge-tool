...
// capture the POSTs
// $postMakeSession = $_POST['makeSessionGet'];
// $postBack = $_POST['back'];
// $postCar = $_POST['cars'];
// $postVehicleBike = $_POST['vehicle'] = 'bike';
// $postVehicleCar = $_POST['vehicle'] = 'car';

pickupPostIfSet("makeSession", $postMakeSession);
