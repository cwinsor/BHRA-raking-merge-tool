...
if ($getContextRakers)
{
    ...
    $databaseTableRakers = new DatabaseTableRakers("rakers");
    $databaseTableRakers->databaseRead(new DatabaseRowRaker()); // give example to clone
    
    // modify an entry and post to database
    if ($postModifyEntry)
    {
        $id = 1;
        $myRaker = $databaseTableRakers->modelGetById($id);
        echo "<br> before... <br>";
    ...
    $databaseTableRakers = new DatabaseTableRakers("rakers");
    $databaseTableRakers->databaseRead(new DatabaseRowRaker());
    echo '<br>' . '--- RAKERS ---' . '<br>';
    var_dump($databaseTableRakers);
