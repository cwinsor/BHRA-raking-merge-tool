...
$custEmail = array();
$custAddress = array();
$databaseTableOrFileName = $ini['db_table_appointments'];
$itemToClone = new ControllerRowAppointment();

$db = mysqli_connect($ini['databasehost'], $ini['databaseusername'], $ini['databasepassword'], $ini['databasename']);
...
/////////////////////
// first the kids
$databaseTableOrFileName = $ini['db_table_roster_raker'];
...
/////////////////////
// then the parents
$databaseTableOrFileName = $ini['db_table_roster_parent'];
