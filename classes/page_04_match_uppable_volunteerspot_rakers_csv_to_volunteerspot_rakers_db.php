...
<html>
    ...
    <body>
        ...
        <div id="content">
            ...
            echo "Choose file:";
            $dirName = $ini['upload_path_volunteerspot_rakers'];
            $d = dir($dirName);
            ...
            if ($getFilename) {
                ...
                $controllerTableRakers2 = new ControllerTable($ini['db_table_volunteerspot_rakers'], "DB", new ControllerRowVolunteerspotRaker());
