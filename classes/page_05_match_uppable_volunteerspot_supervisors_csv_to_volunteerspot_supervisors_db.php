...
<html>
    ...
    <body>
        ...
        <div id="content">
            ...
            echo "Choose file:";
            $dirName = $ini['upload_path_volunteerspot_supervisors'];
            $d = dir($dirName);
            ...
            if ($getFilename) {
                ...
                $controllerTableSupervisors2 = new ControllerTable($ini['db_table_volunteerspot_supervisors'], "DB", new ControllerRowVolunteerspotRaker());
